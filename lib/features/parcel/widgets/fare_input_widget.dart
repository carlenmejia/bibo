            ...
            child: Container(height: 45,
              ...
              child: Center(child: Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment:MainAxisAlignment.spaceBetween,children: [
                ...
                Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall), child: Text(
                  PriceConverter.convertPrice((widget.discountAmount ?? 0) > 0 ? widget.discountFare! : double.tryParse(widget.fare)!),
            ...
            Column(children: [
              if(!widget.fromRide) ...[
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('your_fare'.tr,style: textRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color),),

                  Row(children: [
                    (widget.discountAmount ?? 0) > 0 ?
                    Text(PriceConverter.convertPrice( double.tryParse(widget.fare)!), style: textRegular.copyWith(color: Theme.of(context).hintColor,
                        decoration: TextDecoration.lineThrough,decorationColor: Theme.of(context).hintColor)) : const SizedBox(),

                    Text(PriceConverter.convertPrice((widget.discountAmount ?? 0) > 0 ? widget.discountFare! : double.tryParse(widget.fare)!),
