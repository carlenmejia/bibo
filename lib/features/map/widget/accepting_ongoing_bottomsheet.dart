             ...
             Row(children: [
               ...
               Expanded(child: ButtonWidget(buttonText: 'submit'.tr,
                 ...
                 if(rideController.currentRideState == RideState.acceptingRider){
                   ...
                   rideController.tripStatusUpdate(rideController.tripDetails!.id!, 'cancelled', 'ride_request_cancelled_successfully',Get.find<TripController>().tripCancellationCauseList!.data![0].acceptedRide![Get.find<TripController>().tripCancellationCauseCurrentIndex]);
